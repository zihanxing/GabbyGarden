...
=======
    while True:
        ...
        # Check for the word "bad" in the question as a naive demonstration of content filtering
        if "bad" in user_message.lower(): # Replace with a more robust filter or moderation approach
            print("Let's try to keep our conversation positive and educational! Do you have another question?")
            continue

>>>>>>> 4fea02a257608103a06be5f62b69c9705d786087
    ...
    # st.audio("/Users/macbookp/Desktop/Duke/Semester2023fall/AI_Hackathon/Hack/assets/speech.mp3")
