...
<div class="mySlides fade">
  ...
  <img src="../assets/pics/pic2.jpg" style="width:100%">
  <div class="text">Caption Two</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="../assets/pics/pic3.jpeg" style="width:100%">
...
#         time.sleep(2)
#         st.write(img_template.replace(
#                 "{{img}}", img_path+filename), unsafe_allow_html=True)
#         # st.image(img, width=600)
#     # st.image(img_path+'pic1.jpeg')    
